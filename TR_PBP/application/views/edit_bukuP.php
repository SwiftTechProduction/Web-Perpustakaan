...
<div class="container">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="<?php echo site_url('BukuPController/UpdateBuku/'); ?>" method="post">
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="col-sm-6">
                                <input type="text" name="stok_buku" class="form-control" required pattern="[0-9]*" value="<?php echo $data_edit->stok_buku; ?>">
                            </div>
                        </td>
                    </tr>
