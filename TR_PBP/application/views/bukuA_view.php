                        ...
                        <div class="panel-body">
                            ...
                            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
								 ...
								 <form action="<?php echo site_url('BukuAController/InsertBuku/'); ?>" method="post">
                    ...
                    <?php if (empty($dataBuku)) { ?>
                        ...
                        foreach ($dataBuku as $row) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo site_url('BukuAController/EditBuku/') . '/' . $row->kode_buku; ?>" class="btn btn-info btn-sm"><i class="glyphicon glyphicon-pencil"></i></a>
                                    <a href="<?php echo site_url('BukuAController/HapusBuku/') . '/' . $row->kode_buku; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Anda Yakin menghapus data ini?')">Delete</a>
